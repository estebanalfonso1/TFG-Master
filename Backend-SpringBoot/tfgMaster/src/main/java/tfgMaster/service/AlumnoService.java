...
public class AlumnoService {
	...
	// Busca todos los ALUMNOS que corrige un PROFESOR
	public List<Alumno> getAllAlumnosByProfesor() {

		List<Alumno> alumnos = new ArrayList<>();

		for (Tribunal tribunal : tribunalService.getAllTribunalesByProfesor()) {
			alumnos.add(tribunal.getAlumno());
		}
